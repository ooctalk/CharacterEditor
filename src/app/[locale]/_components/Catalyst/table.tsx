...
export function Table({
  ...
  return (
    <TableContext.Provider
      value={{ bleed, dense, grid, striped } as React.ContextType<
        typeof TableContext
      >}
    >
...
export function TableRow({
  ...
  return (
    <TableRowContext.Provider
      value={{ href, target, title } as React.ContextType<
...
export function TableCell(
  { className, children, ...props }: React.ComponentPropsWithoutRef<"td">,
) {
