      ...
      <div className="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none ">
        <div className="-m-2 rounded-xl bg-gray-900/5 dark:bg-gray-200/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4 ">
          <Image
            ...
            width={1000}
            height={667}
            className="md:w-[48rem] w-[32rem] rounded-md shadow-2xl ring-1 ring-gray-900/10  block dark:hidden"
          />
          <Image
            src="/hero-dark.webp"
            alt="Cyberwaifu.org"
            width={1000}
            height={667}
            className="md:w-[48rem] w-[32rem] rounded-md shadow-2xl ring-1 ring-gray-900/10 hidden dark:block"
          />
        </div>
      </div>
    </div>
